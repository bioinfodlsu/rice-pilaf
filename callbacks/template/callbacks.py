...
def init_callback(app):
    ...
    def submit_template_input(n_clicks, homepage_is_submitted, addl_genes, radio_buttons, checkbox_buttons, parameter_slider):
    ...
    def display_template_submitted_input(template_is_submitted, genes, radio_buttons, checkbox_buttons, submitted_parameter_slider):
        """
        ...
        if template_is_submitted:
            ...
            return [html.B('Additional Genes: '), genes,
                    html.Br(),
                    html.B('Selected Radio Buttons: '), radio_buttons,
                    html.Br(),
                    html.B('Selected Checkbox Buttons: '), html.Span(checkbox_message),
                    html.Br(),
                    html.B('Selected Parameter: '), submitted_parameter_slider]
