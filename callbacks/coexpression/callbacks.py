...
def init_callback(app):
    ...
    @app.callback(
        ...
        Output("coexpression-submitted-addl-genes", "data", allow_duplicate=True),
        Output("coexpression-valid-addl-genes", "data", allow_duplicate=True),
        Output("coexpression-combined-genes", "data", allow_duplicate=True),
        Output("coexpression-submitted-network", "data", allow_duplicate=True),
        Output("coexpression-submitted-clustering-algo", "data", allow_duplicate=True),
        Output("coexpression-submitted-parameter-slider", "data", allow_duplicate=True),
    ...
    def submit_coexpression_input(
        coexpression_submit_n_clicks,
    ...
    def open_modals(
        ...
        if (
            ctx.triggered_id == "coexpression-clustering-algo-tooltip"
            and algo_tooltip_n_clicks > 0
        ):
            return True, False, False, False

        if (
            ctx.triggered_id == "coexpression-network-tooltip"
            and network_tooltip_n_clicks > 0
        ):
            return False, True, False, False

        if (
            ctx.triggered_id == "coexpression-parameter-tooltip"
            and parameter_tooltip_n_clicks > 0
        ):
            return False, False, True, False

        if (
            ctx.triggered_id == "coexpression-converter-tooltip"
    ...
    def display_coexpression_submitted_input(
    ...
    @app.callback(
        ...
        Output("coexpression-module-graph-node-data", "children", allow_duplicate=True),
        Output(
    ...
    def download_coexpression_graph_to_tsv(
        download_n_clicks,
        submitted_network,
        submitted_algo,
        submitted_parameter_slider,
    ...
    def set_submitted_coexpression_session_state(
    ...
    def get_submitted_coexpression_session_state(
        submitted_network, submitted_algo, coexpression_is_submitted, layout, active_tab
    ):
        """
