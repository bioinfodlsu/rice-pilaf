        ...
        children=[
            dbc.Row([
                dbc.Col([
                    ...
                    html.P('RicePilaf is a web app for post-GWAS/QTL analysis that performs a slew of novel bioinformatics analyses to cross GWAS results and QTL mappings with a host of publicly available rice databases. ', className='pt-3'),
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    html.P('Co-expression networks provide a means to identify sets of genes acting together to produce a trait. For genes with poor annotations or unknown functions, their membership in a dense subnetwork containing well-characterized genes might be a way to uncover incomplete functional information.', className='pt-3'),
            ...
            dbc.Row([
                dbc.Col([
                    html.H5('Text Mining'),
                    html.P('The gene list provided to the co-expression and regulatory enrichment analyses can be supplemented by genes retrieved from the pangenome lift-over and from querying our in-house dataset obtained by text mining PubMed abstracts on rice gene-trait associations. Additionally, the same text-mining dataset is used to find scientific literature related to the genes overlapping the input interval.', className='pt-3'),
                ], className='col-sm-9'),
