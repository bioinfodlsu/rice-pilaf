...
fun_tfbs = html.Li(
    [
        ...
        html.Br(),
        html.Span(
            "Identification of binding sites with transcriptional regulatory functions based on the correlation between binding motif frequencies and conservation scores",
            className="algo-desc",
        ),
        html.Div(
            [
...
motif_conservation = html.Li(
    [
        html.B("Motif Conservation"),
        html.Br(),
        html.Span(
            "Motif scanning paired with conserved element information",
            className="algo-desc",
        ),
        html.Div(
            [
...
motif_scanning = html.Li(
    [
        html.B("Motif Scan"),
        html.Br(),
        html.Span("Simple motif scanning using FIMO", className="algo-desc"),
        html.Div(
            [
                html.Span(
...
prediction_technique_modal = dbc.Modal(
    [
        dbc.ModalHeader(
            dbc.ModalTitle("Transcription Factor Binding Site Prediction Technique"),
        ),
        dbc.ModalBody(
            [
                html.P(
                ...
                html.Ul(
                    [fun_tfbs, html.Br(), motif_conservation, html.Br(), motif_scanning]
                ),
            ]
        ),
    ],
...
layout = html.Div(
    id={"type": "analysis-layout", "label": Constants.LABEL_TFBS},
    hidden=True,
    children=[
        html.Div(
            [
        ...
        html.Div(
            [
                ...
                dbc.Label(
                    [
                        "Select a transcription factor binding site prediction technique",
                        html.I(
                            className="bi bi-info-circle",
                ...
                dbc.Label(
                    [
                        "Consider transcription factor binding sites in the following regions",
                        html.I(
                            className="bi bi-info-circle",
                            id="tfbs-set-tooltip",
                            n_clicks=0,
            ...
            children=[
                dcc.Loading(
                    [
                        ...
                        html.Br(),
                        html.Div(id="tfbs-input", className="analysis-intro p-3"),
                        html.Br(),
                        html.P(
                            html.Div(
                                [
                                    html.Div(
                                        [html.Span(id="tfbs-table-stats")],
