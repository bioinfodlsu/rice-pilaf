...
COLUMN_TOOLTIPS = {
    ...
    "# Modules": "Total number of co-expression modules that include the gene",
    "# Enriched Modules": "Number of enriched co-expression modules that include the gene",
    "# Gene Ontology Terms": "Total number of gene ontology terms related to the gene",
    "# Enriched Gene Ontology Terms": "Number of gene ontology terms that are overrepresented in the enriched co-expression modules containing the gene",
    "# Trait Ontology Terms": "Total number of trait ontology terms related to the gene",
    "# Enriched Trait Ontology Terms": "Number of trait ontology terms that are overrepresented in the enriched co-expression modules containing the gene",
    "# Plant Ontology Terms": "Total number of plant ontology terms related to the gene",
    "# Enriched Plant Ontology Terms": "Number of plant ontology terms that are overrepresented in the enriched co-expression modules containing the gene",
    "# Pathways": "Total number of pathways related to the gene",
    "# Enriched Pathways (Over-Representation)": "Number of pathways that are impacted in the enriched co-expression modules containing the gene (determined via over-representation analysis)",
    "# Enriched Pathways (Pathway-Express)": "Number of pathways that are impacted in the enriched co-expression modules containing the gene (determined via the topology-aware method Pathway-Express)",
    "# Enriched Pathways (SPIA)": "Number of pathways that are impacted in the enriched co-expression modules containing the gene (determined via topology-aware method SPIA)",
}
