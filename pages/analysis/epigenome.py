...
layout = html.Div(
    ...
    hidden=True,
    children=[
        html.Div([html.P(Constants.INTRO_EPIGENOME)], className="analysis-intro p-3"),
        html.Br(),
        html.Div(
            [
        ...
        html.Div(
            [
                ...
                dbc.Checklist(
                    id="epigenome-tracks", inline=True, className="ms-3 mt-1", value=[]
                ),
                html.Br(),
                dbc.Button(
                    "Submit", id="epigenome-submit", n_clicks=0, className="page-button"
                ),
            ],
            className="analysis-intro p-3",
        ),
