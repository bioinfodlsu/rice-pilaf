...
import re, _pickle as cPickle, sys
import argparse
...
def main(input):
    ...
    sources = ["LOC_.*", "OsCMeo.*", "OsAzu.*", "OsKeNa.*", "OsARC.*", "OsPr106.*","OsMH63.*","OsIR64.*","OsZS97.*","OsLima.*","OsKYG.*","OsGoSa.*","OsLiXu.*","OsLaMu.*","OsN22.*","OsNaBo.*"]
    files = ["Nipponbare", "ChaoMeo", "Azucena", "KetanNangka", "ARC10497", "PR106", "Minghui63", "IR64", "Zhenshan97","LIMA","KhaoYaiGuang","GobolSail","LiuXu","LarhaMugad","N22","NatelBoro"]
