...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "pubmed_dictionary_dir",
        help="directory containing the dictionaries with the PubMed IDs of related articles",
    )
    parser.add_argument(
        "output_dir",
        help="output directory for the dictionary consolidating the PubMed IDs of related articles",
    )

    args = parser.parse_args()

    consolidate_pubmed_dictionaries(args.pubmed_dictionary_dir, args.output_dir)
