...
def map_symbol_to_msu(gene_index_file):
    ...
    with open(gene_index_file, encoding='utf8') as f:
        ...
        for line in csv_reader:
            ...
            gene_symbols = [symbol.lower()
                            for symbol in list(filter(None, gene_symbols))]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'output_dir', help='output directory for the pickled dictionary mapping gene symbols (names) to their MSU IDs')
