...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "geneset_file",
        help="text file mapping the genes to their respective KEGG pathways",
    )
    parser.add_argument(
        "output_dir",
        help="output directory for the pickled dictionary mapping KEGG pathways to their genes",
    )
