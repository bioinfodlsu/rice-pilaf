...
def save_msu_entrez_mapping(msu_to_entrez_dict, output_dir):
    ...
    with open(f"{output_dir}/msu-to-entrez-id.pickle", "wb") as handle:
        pickle.dump(msu_to_entrez_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "output_dir",
        help="output directory for the pickled dictionary mapping MSU accessions to their respective Entrez IDs",
    )
