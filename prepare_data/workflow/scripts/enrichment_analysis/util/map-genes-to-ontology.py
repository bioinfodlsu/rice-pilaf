...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "output_dir",
        help="output directory for the pickled dictionary mapping genes to their ontology terms",
    )
    parser.add_argument(
        "option",
        help='can be "go" (for gene ontology), "po" (for plant ontology), "to" (for trait ontology), or "pathway"',
    )
    parser.add_argument(
    ...
    export_mapping(
        map_genes_to_ontology(args.ontology_files), args.output_dir, args.option
    )
