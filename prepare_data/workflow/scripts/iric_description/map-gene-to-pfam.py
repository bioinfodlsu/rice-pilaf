...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'iric_data_file', help='Pfam annotation file from IRIC')
    parser.add_argument(
        'pfam_to_name_file', help='text file mapping Pfam accessions to their respective names')
    parser.add_argument(
        'output_dir', help='output directory for the pickled accession-to-Pfam annotation dictionary')

    args = parser.parse_args()

    mapping_dict = generate_dict(
        args.iric_data_file, args.pfam_to_name_file)
